...
const streams = [
  {
    ...
    title: "Live Worship",
    content:
      "Join us for live worship services, prayer meetings, and special events streamed directly to your device.",
  },
  {
    id: 2,
    icon: calender2,
  ...
  },
  {
    ...
    icon: notification,
    content:
      "Get notified when live streams begin and new content becomes available.",
  },
];
